...
const commonJapaneseWords:wordCard[] = [
    ...
    ["一本","一本 いっぽん one long thing<br>一本の鉛筆 いっぽんのえんぴつ One pencil<br>一本の線 いっぽんのせん One line"],
    ["二本","二本 にほん two long things<br>二本の鉛筆 にほんのえんぴつ Two pencils<br>二本の線 にほんのせん Two lines"],
    ["三本","三本 さんぼん three long things<br>三本の鉛筆 さんぼんのえんぴつ Three pencils<br>三本の線 さんぼんのせん Three lines"],
    ["四本","四本 よんほん four long things<br>四本の鉛筆 よんほんのえんぴつ Four pencils<br>四本の線 よんほんのせん Four lines"],
    ["五本","五本 ごほん five long things<br>五本の鉛筆 ごほんのえんぴつ Five pencils<br>五本の線 ごほんのせん Five lines"],
    ["六本","六本 ろっぽん six long things<br>六本の鉛筆 ろっぽんのえんぴつ Six pencils<br>六本の線 ろっぽんのせん Six lines"],
    ["七本","七本 ななほん seven long things<br>七本の鉛筆 ななほんのえんぴつ Seven pencils<br>七本の線 ななほんのせん Seven lines"],
    ["八本","八本 はっぽん eight long things<br>八本の鉛筆 はっぽんのえんぴつ Eight pencils<br>八本の線 はっぽんのせん Eight lines"],
    ["九本","九本 きゅうほん nine long things<br>九本の鉛筆 きゅうほんのえんぴつ Nine pencils<br>九本の線 きゅうほんのせん Nine lines"],
    ["十本","十本 じゅっぽん ten long things<br>十本の鉛筆 じゅっぽんのえんぴつ Ten pencils<br>十本の線 じゅっぽんのせん Ten lines"],
